...
output_df = exp_prkcosts_df.join(districts_df['parking_type']).join(imputed_parking_df['spaces'])
output_df['spaces'].fillna(0,inplace=True)
output_df.rename(columns={'spaces':'parking_spaces'},inplace=True)
